...
const page = () => {
    ...
    return (
        <section className="container mx-auto h-full py-20">
                    ...
                    services.map((service, index) => (
                        <div key={index} className="items-center space-y-5 border-b border-b-orange-600 pb-3 group">
                            ...
                            <div className="space-y-2">
                                <h3 className="text-3xl font-bold group-hover:text-orange-600 duration-500 transition-all">{service.title}</h3>
